...
from cmp.tools.LL1_Parser import LL1Parser
...
class Regex:
    ...
    def parser(self):
        ...
        ll1 = LL1Parser(self.G, firsts, follows)
        M = ll1.build_parsing_table(self.G, firsts, follows)
        parser =ll1.predictive_non_recursive_method(self.G, M)
        return parser